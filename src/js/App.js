...
const EventPlog = createLoadable(() => import('./components/event-plog'  /* webpackChunkName: "EventPlog" */))
const User = createLoadable(() => import('./components/user'  /* webpackChunkName: "EventPlog" */))
const JoinACommunity = createLoadable(() => import('./components/join-a-community' /* webpackChunkName: "JoinACommunity" */))
    ...
    return (
      <StyledApp>
        <Switch>
          ...
          <PrivateRoute path="/events" component={EventPlog} />
          <PrivateRoute path="/join-a-community" component={JoinACommunity} />
        </Switch>
      </StyledApp>
    )
  }
