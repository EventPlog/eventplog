...
import { genCategoryLink } from 'js/utils'
    ...
    <StyledHeader>
      <div className="app-container logo">
        ...
        <div className="right-pull">
          {(is_owner || is_admin)
            ? <Button.Link className="edit-category"
                           activeClassName="hidden"
                           to={`${categoryLink}/edit`}>
                Edit
              </Button.Link>
            : following
              ? <Button onClick={() => unFollowCategory(buildFollowableParams(category))}>
                  <Icon color='green' name='checkmark' size='large' />
                  Following
                </Button>
              : id &&
              <Button
                onClick={() => followCategory(buildFollowableParams(category))}>
                Follow
              </Button>
          }
        </div>
      ...
      <div className="nav-holder">
        <div className="app-container">
          <Nav hideOnMobile={hideMenu} StackUlOnMobile={false}>
            <Nav.Item>
              <Link to={`${categoryLink}/e`}>Events</Link>
            </Nav.Item>
            ...
            {(is_owner || is_admin) &&
            <Nav.Item>
              <Button.Link to={`${categoryLink}/e/new`} activeClassName="hidden">
