...
const PrivacyPolicy =()=>{
  return(
    ...
    <div className="privacy-policy-container">
        ...
        <text className="content">This privacy policy has been compiled to better serve those who are 
        ...
        Information in accordance with our website.</text>

          <subtitle><h6 className="subtitle">What personal information do we collect from the people 
          that visit our blog, website or app?</h6></subtitle>
          <text className="content">When ordering or registering on our site, as appropriate, 
          ...
          <text className="content">We collect information from you when you register on our site, 
          respond to a survey or enter information on our site.</text>
          <subtitle><h6 className="subtitle">How do we use your information?</h6></subtitle>
          <text className="content">We may use the information we collect from you when you register, 
          ...
          <text className="content">Yes. Cookies are small files that a site or its service provider 
          ...
          that we can offer better site experiences and tools in the future.</text>
          ...
          <text className="content">We do not sell, trade, or otherwise transfer to outside parties your 
          Personally Identifiable Information.</text>

          <subtitle><h6 className="subtitle"> Third-party links</h6></subtitle>
          <text className="content">We do not include or offer third-party products or services on our website.
          </text>
          ...
          <text className="content">
           ...
           <subtitle><h6 className="subtitle">In order to be in line with Fair Information Practices we will 
           take the following responsive action, should a data breach occur: </h6></subtitle>
          <text className="content">
