...
const TermsAndConditionsPage =()=>{
  return(
    ...
    <div className="terms-and-conditions-container">
      ...
      <TextTitle>Your Relationship with EventPlog</TextTitle>
      <TextContent>
        ...
        and recurring basis (unless you disable auto-renewal or cancel your subscription).</TextContent>

      <TextTitle>EventPlog Groups, Organizers and Members</TextTitle>
      <TextContent>Organizers may establish membership criteria for their own 
      EventPlog Community. While there is probably an EventPlog Community out there for everyone,
        ...
        you can easily start your own EventPlog community.</TextContent>
      
      <TextTitle>Organizers may charge fees for memberships or events.</TextTitle>
      <TextContent>Using our Platform involves meeting real people and doing real 
      ...
      <TextTitle>Your Content and Content of Others</TextTitle>
      <TextContent>You are responsible for your “Content”, which means any information,
      ...
      <TextTitle>User Submissions</TextTitle>
      <TextContent>Anything that you submit to the Site and/or provide to us, 
      ...
      <TextTitle>The permissions you give us</TextTitle>
      <TextContent>We need certain permissions from you to provide our services:<br/><br/>
      ...
      <TextTitle>Our Platform</TextTitle>
      <TextContent>We try hard to make sure that our Platform is always available and working,
      ...
      <TextTitle>Accessibility of Website</TextTitle>
      <TextContent>Our aim is to ensure accessibility to the website at all times, however we
      ...
      <TextTitle>Links and Third Party Websites</TextTitle>
      <TextContent>We may include links to third party websites at any time. However, the 
      ...
      <TextTitle>Intellectual Property</TextTitle>
      <TextContent>Both parties agree that all intellectual property rights and database rights, 
      ...
      <TextTitle>Data Protection</TextTitle>
      <TextContent>Any personal information collected in relation to the use of this 
      website will be held and used in accordant with our Privacy Policy.
      </TextContent>
      <TextTitle>Additional provisions</TextTitle>
      <TextContent><br/>
