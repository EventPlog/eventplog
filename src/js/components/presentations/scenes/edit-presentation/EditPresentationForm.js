...
export const EditUserForm = ({
  ...
  const { community_id, event_id, presentation_id } = match.params
  ...
  return (
    <StyledEditUserForm className="">
      <div className="app-container">
        <ContentPanel title={<p>Edit Presentation Information</p>}>
          <Form loading={loading} success={success} error={error}>
            ...
            <Button.Link to={`${genEventLink(event, event.community)}/presentations/${match.params.presentation_id}`}>
              Back/Cancel
            </Button.Link>
          </Form>
        </ContentPanel>
