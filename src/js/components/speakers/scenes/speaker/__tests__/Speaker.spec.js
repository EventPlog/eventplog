...
describe('Speaker', () => {
  ...
  const wrapper = shallow( <Speaker {...props} /> );
  ...
  describe('when it renders the content panels', () => {
    ...
    test('it renders the title panel with the right info and children', () => {
      ...
      expect(contentPanelInstances.at(0).props().title).toEqual(`Title of the ${props.speaker.presentation_type}`)
      expect(contentPanelInstances.at(0).find(ContentEditable).length).toEqual(1)
      expect(contentPanelInstances.at(0).find(ContentEditable).at(0).props().defaultValue).toEqual(props.speaker.title)
    })
    ...
    test('it renders the summary panel with the right info and children', () => {
      ...
      expect(contentPanelInstances.at(1).find(ContentEditable).at(0).props().defaultValue).toEqual(props.speaker.summary)
    })
    ...
    test('it renders the details panel with the right info and children', () => {
      ...
      expect(contentPanelInstances.at(2).find(ContentEditable).at(0).props().defaultValue).toEqual(props.speaker.details)
    })
    ...
    test('it renders the comments panel with the right info and children', () => {
      ...
      expect(contentPanelInstances.at(3).find(AddComment).at(0).props().recipient_type).toEqual('Speaker')
      expect(contentPanelInstances.at(3).find(AddComment).at(0).props().recipient_id).toEqual(props.speaker.id)

      expect(contentPanelInstances.at(3).find(Comments).length).toEqual(1)
      expect(contentPanelInstances.at(3).find(Comments).at(0).props().recipient_type).toEqual('Speaker')
      expect(contentPanelInstances.at(3).find(Comments).at(0).props().recipient_id).toEqual(props.speaker.id)
    })
  })
  ...
  describe('when the sidebar is rendered', () => {
    ...
    test('it renders the AboutUser component with the right props', () => {
      ...
      expect(sidebar.at(0).find(AboutUser).at(0).props().user).toEqual(props.speaker.user)
    })
